...
// Menu groups - condensados como admin, mas com menos opções
const menuGroups = [
  {
    label: "Operacional",
    color: "blue",
  ...
  },
  {
    ...
    color: "purple",
    items: [
      { icon: MessageCircle, label: "Comunicação", path: "/admin/communication" },
    ],
  },
  {
    label: "Gestão",
    color: "green",
    items: [
      { icon: Wallet, label: "Pacotes & Financeiro", path: "/admin/packages" },
      { icon: Settings, label: "Configurações", path: "/admin/users" },
    ],
  },
];
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              O acesso a este portal requer autenticação. Continue para fazer login.
            </p>
          </div>
          <Button
            onClick={() => {
