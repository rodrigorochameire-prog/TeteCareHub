      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="default" size="sm" className="gap-2" onClick={() => setLocation("/register")}>
              Criar Conta
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Button size="lg" className="gap-2 text-base px-8 h-12 shadow-lg hover:shadow-xl transition-all" onClick={() => setLocation("/register")}>
                Começar Agora
              ...
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-orange-100 via-teal-50 to-blue-100 p-8 flex items-center justify-center">
                <div className="text-center space-y-4">
                  <img
                    src="/tetecare-logo.png"
                    alt="Tetê Care"
                    className="w-48 h-48 rounded-3xl object-cover mx-auto shadow-2xl border-4 border-white"
                  />
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 md:p-12 text-center bg-gradient-to-br from-primary/5 via-primary/10 to-accent/5 border-2 border-primary/20">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Button size="lg" className="gap-2 text-base px-8 h-12 shadow-lg hover:shadow-xl transition-all" onClick={() => setLocation("/login")}>
                  Acessar Plataforma
                  <ArrowRight className="w-5 h-5" />
                </Button>
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">
                © 2024 Tetê Care. Todos os direitos reservados.
              </span>
            </div>
