...
const menuGroups = [
  {
    ...
    items: [
      ...
      { icon: CheckCircle2, label: "Aprovações", path: "/admin/pet-approval" },
      { icon: Calendar, label: "Calendário", path: "/admin/health-calendar" },
    ],
  },
  {
    label: "Cuidados",
  ...
  },
  {
    ...
    color: "orange",
    items: [
      { icon: MessageCircle, label: "Central de Comunicação", path: "/admin/communication" },
    ],
  },
  {
    label: "Pacotes & Financeiro",
    color: "green",
    items: [
      { icon: Wallet, label: "Central de Pacotes", path: "/admin/packages" },
    ],
  },
  {
    label: "Gestão",
    ...
    items: [
      ...
      { icon: ScrollText, label: "Auditoria", path: "/admin/audit-logs" },
      { icon: GitMerge, label: "Cogestão", path: "/admin/comanagement" },
    ],
  },
];
