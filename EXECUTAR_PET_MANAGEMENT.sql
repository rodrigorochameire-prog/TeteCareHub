...
-- ==========================================
-- TABELA: CÍRCULO SOCIAL (Afinidades/Restrições)
-- ==========================================
...
-- ==========================================
-- TABELA: LOG DE ALIMENTAÇÃO (com consumo)
-- ==========================================
...
SELECT 
  'Migração de Gestão Avançada concluída!' AS resultado,
  (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'pets' AND column_name = 'energy_level') AS pets_energy_level,
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_name = 'pet_social_circle') AS circulo_social,
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_name = 'pet_weight_history') AS historico_peso,
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_name = 'pet_feeding_logs') AS log_alimentacao,
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_name = 'pet_training_skills') AS habilidades_adestramento,
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_name = 'pet_alerts') AS alertas;
